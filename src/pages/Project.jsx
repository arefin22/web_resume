        ...
        <div id="projects" className="gradient-background rounded-2xl m-5 p-4 text-black py-52">
            ...
            <div className="grid grid-cols-3 gap-4">
                <a href="https://jobshq-7364c.web.app/">
                    <div>
                        <img src="/src/assets/project1.png" target="_blank" alt="JOBsHQ" />
                ...
                <a href="https://lifemark-5a6d7.web.app/">
                    <div>
                        <img src="/src/assets/project2.png" target="_blank" alt="Life Mark" />
                ...
                <a href="https://beverage-io-d271b.web.app/">
                    <div>
                        <img src="/src/assets/project3.png" target="_blank" alt="Beverage.IO" />
